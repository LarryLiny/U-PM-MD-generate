...
> 文件命名规则: `PM_Requirement/Requirement_[版本号]/[项目名]_requirement_[版本号].md`，项目名从 package.json 的 `name` 字段或目录名提取，使用 PascalCase 格式。例如 `PM_Requirement/Requirement_0622001/AIPPT_requirement_0622001.md`。
